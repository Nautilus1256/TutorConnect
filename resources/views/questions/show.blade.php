<x-app-layout>
    <div class="question-show-area my-8 rounded-2xl px-16 py-8">
        ...
        <div class="question-content rounded-2xl bg-white p-8">
            ...
            <div class="images flex flex-wrap items-center justify-around">
                @foreach ($images as $image)
                    <div>
                        <img src="{{ $image->image_url }}" alt="画像が読み込めません。" class="question-show-image object-contain" />
                    </div>
                @endforeach
            </div>
        </div>
            ...
            @foreach ($answers as $answer)
                ...
                <div class="answer-content flex flex-col gap-4 rounded-2xl bg-white p-8">
                    @if ($answer->best_answer)
                        <div class="best-answer flex items-center gap-2 text-3xl font-bold">
        ...
        <div class="flex items-center justify-around pt-16">
            <a href="/" class="question-show-return-btn text-2xl font-bold underline">ホームに戻る</a>
        </div>
    </div>
</x-app-layout>
