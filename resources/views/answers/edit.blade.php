        ...
        <div class="answer-area h-screen-40 w-1/2">
            <form action="/questions/{{$question->id }}/answers/{{ $answer->id }}" method="POST" class="h-full-16 mx-8 my-8 pb-8">
                ...
                <div class="comment h-full-23.5 mb-8">
                    <textarea name="answer[comment]" placeholder="回答を入力してください" class="h-full w-full rounded-2xl p-8 text-xl count-text" data-maxlength="400">{{ $answer->comment }}</textarea>
